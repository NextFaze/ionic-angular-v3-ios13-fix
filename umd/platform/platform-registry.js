(function (factory) {
    ...
    exports.PLATFORM_CONFIGS = {
        ...
        'ios': {
            ...
            isMatch: function (plt) {
                return plt.isPlatformMatch('ios', ['iphone', 'ipad', 'ipod'], ['windows phone']) || platform_utils_1.isIos(plt);
            },
            versionParser: function (plt) {
        ...
        'ipad': {
            ...
            isMatch: function (plt) {
                return plt.isPlatformMatch('ipad') || platform_utils_1.isIpad(window);
            }
        },
        /**
         * iphone
