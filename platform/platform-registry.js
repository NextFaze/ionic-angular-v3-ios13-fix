...
import { isCordova, isElectron, isIos, isIpad, isIosUIWebView } from './platform-utils';
export var PLATFORM_CONFIGS = {
    ...
    'ios': {
        ...
        isMatch: function (plt) {
            return plt.isPlatformMatch('ios', ['iphone', 'ipad', 'ipod'], ['windows phone']) || isIos(plt);
        },
        versionParser: function (plt) {
    ...
    'ipad': {
        ...
        isMatch: function (plt) {
            return plt.isPlatformMatch('ipad') || isIpad(window);
        }
    },
    /**
     * iphone
